                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="relative h-64 md:h-80 rounded-3xl overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-6 z-10 bg-gradient-to-t from-brand-black/90 via-brand-black/70 to-transparent">
                            ...
                            <p className="text-white/90 text-base md:text-lg">Más de 5,000 dispositivos restaurados con éxito</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="md:col-span-3">
                            ...
                            <p className="text-white/70 mb-4">Expertos en Macintosh comprometidos con la economía circular y la sostenibilidad. Más de 10 años restaurando dispositivos Apple.</p>
