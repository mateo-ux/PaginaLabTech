                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="md:col-span-3">
                            ...
                            <p className="text-white/70 mb-4">Expertos en Macintosh comprometidos con la economía circular y la sostenibilidad. Más de 5 años restaurando dispositivos Apple.</p>
