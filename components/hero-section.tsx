    ...
    return (
        <section id="inicio" className="relative min-h-screen pt-24 flex items-center justify-center bg-brand-black overflow-hidden">
            ...
            <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 animate-fade-in drop-shadow-[0_4px_20px_rgba(0,0,0,0.8)]">
                    Expertos en <span className="bg-gradient-to-r from-brand-blue to-brand-green bg-clip-text text-transparent drop-shadow-none">Macintosh</span>
                </h1>
